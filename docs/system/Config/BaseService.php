...
use docs\app\Config\Autoload;
use docs\app\Config\Cache;
use docs\app\Config\Encryption;
use docs\app\Config\Exceptions as ConfigExceptions;
use docs\app\Config\Filters as ConfigFilters;
use docs\app\Config\Format as ConfigFormat;
use docs\app\Config\Honeypot as ConfigHoneyPot;
use docs\app\Config\Images;
use docs\app\Config\Migrations;
use docs\app\Config\Modules;
use docs\app\Config\Pager as ConfigPager;
use docs\app\Config\Services as AppServices;
use docs\app\Config\Toolbar as ConfigToolbar;
use docs\app\Config\Validation as ConfigValidation;
use docs\app\Config\View as ConfigView;
