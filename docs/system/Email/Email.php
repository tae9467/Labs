...
class Email
{
     ...
     *
     * @see \docs\app\Config\Email::$wordWrap
     *
     * @var int
     */
    public $wrapChars = 76;
     ...
     *
     * @see \docs\app\Config\Email::$BCCBatchMode
     *
     * @var int|string
     */
     ...
     *
     * @see \docs\app\Config\Email::$protocol
     *
     * @var array
     */
    protected $protocols = [
     ...
     *
     * @param array|\docs\app\Config\Email $config
     *
     * @return Email
     */
    public function initialize($config)
    {
        ...
        if ($config instanceof \docs\app\Config\Email) {
