...
use docs\app\Config\Paths;
use docs\app\Config\Services;
...
if (! class_exists('docs\app\Config\Autoload', false)) {
...
if (! class_exists('CodeIgniter\Services', false)) {
    class_alias('docs\app\Config\Services', 'CodeIgniter\Services');
}
